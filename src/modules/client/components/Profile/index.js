...
class Profile extends React.Component {
  ...
  componentDidMount() {
    ...
    if(!profile.email) fetchUserProfile(this.props.match.params.id).then(profile =>
  ...
  submitEditProfile = () => {
    ...
    profileData.id = id;
    this.props.editUserProfile(profileData)
      .then(res => {
...
export default connect(
  mapStateToProps,
  { fetchUserProfile, editUserProfile }
)(Profile);